export const FUNIL_STAGES = [
  ...
  { id: 'FOLLOW_UP', label: 'Follow Up', color: '#8b5cf6', gradient: 'from-violet-500/20 to-transparent', ring: 'ring-violet-500/30' },
  { id: 'PROPOSTA', label: 'Proposta', color: '#06b6d4', gradient: 'from-cyan-500/20 to-transparent', ring: 'ring-cyan-500/30' },
